        ...
        <Form>
          ...
          <Item regular style={PollingStyle.inputStyle}>
            <Input
              ...
              value={polling && polling.answer && polling.answer[0] ? polling.answer[0].name : ''}
             />   
          </Item>
          ...
          <Item regular style={PollingStyle.inputStyle}>
            <Input
              ...
              onChangeText={(content) => handleAnswer('answer', content)}
              value={polling && polling.answer && polling.answer[1] ? polling.answer[1].name : ''}
            />
          </Item>
          ...
          <Item regular style={PollingStyle.inputStyle}>
            <Input
              ...
              onChangeText={(content) => handleAnswer('answer', content)}
              value={polling && polling.answer && polling.answer[2] ? polling.answer[2].name : ''}
            />
          </Item>
