...
const ExpenseManager = ({route, navigation}) => {
  ...
  const showAnalytics = (total, remaining) => {
            ...
            <CardItem>
              <Body style={expenseManagerStyles.cardBody}>
                ...
                <CardItem style={expenseManagerStyles.budget}>
                  <Left>
                    <Text style={expenseManagerStyles.name}>
                      {budget.budgetName}
                    </Text>
                  </Left>
                  <Right>
                    <Text style={expenseManagerStyles.amount}>
                      ${budget.budgetAmount}
                    </Text>
                  </Right>
                </CardItem>
            ...
            <Row size={100}>
              <Tabs
                ...
                tabBarUnderlineStyle={
                  expenseManagerStyles.tabBarUnderlineStyle
                }>
                <Tab
                  heading="Spendings"
